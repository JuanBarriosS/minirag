...
*Proyecto desarrollado como taller práctico de Spring Boot + Spring AI + RAG* 🎓

</div>

manda todo junto para coiar

Consolidating the response into one copyable block.
markdown
# 🧠 MiniRAG Académico
...
todo junto en una sola pantalla negra para copiarrrrrr no me mandes eso separado
